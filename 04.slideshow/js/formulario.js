...
var mf = {
    ...
    validarFormulario: function () {
        ...
        if (!pf.validarUsuario || !pf.validarPassword || !pf.validarEmail) {
            document.querySelector("#labelEnviar").innerHTML = '<span style="color:red">*¡Hay error en los datos que ha ingresado, revisar de nuevo!</span>';
            return false;
        }else if (!pf.validarTerminos) {
            document.querySelector("#labelEnviar").innerHTML = '<span style="color:red">*¡Acepta terminos y condiciones para continuar</span>';            
            return false;
        }else{
            document.querySelector("#labelEnviar").innerHTML = '<span style="color:red"></span>';            
        }
